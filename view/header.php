...
<html lang="fa" dir="rtl">
  <head>
    ...
    <link
      href="http://localhost/panahi/assets/css/bootstrap.min.css"
      rel="stylesheet"
  ...
  <body>
      ...
      <nav dir="rtl" class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container">
          ...
          <a class="navbar-brand" href="#"
            ><img class="logo" src="http://localhost/panahi/assets/img/logo.png" alt="logo"
          /></a>
    ...
    <script src="http://localhost/panahi/assets/js/main.js"></script>
    <script
      src="http://localhost/panahi/assets/js/bootstrap.bundle.min.js"
